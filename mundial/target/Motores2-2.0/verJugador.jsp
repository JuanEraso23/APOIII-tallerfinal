...
<section class="page-section" id="listado">
    <div class="jugador-container">
        <!-- listado Section Form-->
        <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center">
                    
                    <a class="btn btn-primary btn-xl"  href="inicio.jsp">
                        <i class="fas fa-arrow-alt-circle-left" style="color: black;"></i>
                    </a>
                    <h5 class="" style="color: white">Listado de Jugadores</h5>
                    <a class="btn btn-primary btn-xl" data-bs-toggle="modal" data-bs-target="#nuevoJugaModal">
                        ...
                        <table class="table table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm me-1" style="color: white;" data-bs-toggle="modal" data-bs-target="#verJugador" title="Ver Jugador" onclick="mostrarImagenJugador(<%= jugador.getId() %>, '<%= jugador.getRutaImagen()%>','<%= jugador.getNombre()%>', '<%= jugador.getEdad()%>', '<%= jugador.getAltura()%>', '<%= jugador.getPeso()%>', '<%= jugador.getPosicion()%>', '<%= jugador.getSalario()%>')">
                                            <i class="fas fa-eye"></i> Información
                                        </a>
                                        <a class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#editJugador<%= jugador.getId()%>" title="Editar">
                                            <i class="fas fa-edit text-white"></i> Editar
                                        </a>
                                        <a href="eliminarJugador.do?idEquipo=<%= equipo.getId()%>&idJugador=<%= jugador.getId()%>" onclick="return confirmarEliminar();" class="btn btn-danger btn-sm me-1" title="Eliminar">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h5 class="mb-3">Información del Jugador</h5>
                ...
                <form id="agregarJugadorForm" action="agregarJugador.do" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="posicion" id="posicion" class="form-control" required>
                            ...
                            <option value="Extremo Izquierdo">Extremo Derecho</option>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <select name="posicion" id="posicion" class="form-control" required>
                                ...
                                <option value="Defensa Central" <%= "Defensa Central".equals(jugador.getPosicion()) ? "selected" : "" %>>Defensa Central</option>
                                <option value="Lateral Izquierdo" <%= "Lateral Izquierdo".equals(jugador.getPosicion()) ? "selected" : "" %>>Lateral Izquierdo</option>
                                <option value="Lateral Derecho" <%= "Lateral Derecho".equals(jugador.getPosicion()) ? "selected" : "" %>>Lateral Derecho</option>
                                <option value="Mediocentro Defensivo" <%= "Mediocentro Defensivo".equals(jugador.getPosicion()) ? "selected" : "" %>>Mediocentro Defensivo</option>
                                <option value="Mediocentro" <%= "Mediocentro".equals(jugador.getPosicion()) ? "selected" : "" %>>Mediocentro</option>
                                <option value="Mediocentro Ofensivo" <%= "Mediocentro Ofensivo".equals(jugador.getPosicion()) ? "selected" : "" %>>Mediocentro Ofensivo</option>
                                <option value="Extremo Izquierdo" <%= "Extremo Izquierdo".equals(jugador.getPosicion()) ? "selected" : "" %>>Extremo Izquierdo</option>
                                <option value="Extremo Derecho" <%= "Extremo Derecho".equals(jugador.getPosicion()) ? "selected" : "" %>>Extremo Derecho</option>
